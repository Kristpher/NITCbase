...
RecId BPlusTree::bPlusSearch(int relId, char attrName[ATTR_SIZE], Attribute attrVal, int op) {
    ...
    */
    ...
    while(StaticBuffer::getStaticBlockType(block)==IND_INTERNAL) {  //use StaticBuffer::getStaticBlockType() checking /* block is of type IND_INTERNAL */
        ...
        if (op == NE or op == LT or op == LE/* op is one of NE, LT, LE */) {
            ...
            */
            ...
            while(index<intHead.numEntries){
                ...
                if((op==EQ && cmp==0) || (op==GE && cmp>=0) ||(op==GT && cmp>0 )){
                found=1;
                break;
                }
                index++;
